...
bool getNextNalu(uint8_t*& naluData, int& naluSize, bool& next_frame_flag) {
    naluData = nullptr;
    naluSize = 0;
...
void testSendH264File(FrameCallback callback){
    ...
    if(getNextNalu(naluData, naluSize, next_frame_flag)){
